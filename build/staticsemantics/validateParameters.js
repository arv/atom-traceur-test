  ...
  return ($traceurRuntime.createClass)(ParameterValidationVisitor, {
    visitBindingIdentifier: function(tree) {
      ...
      if (this.reportStrictKeywords_ && (isStrictKeyword(name) || name === 'eval' || name === 'arguments')) {
        this.reporter_.reportError(tree.location.start, (name + " is a reserved identifier"));
      }
    ...
    reportDuplicateError_: function(name, pos) {
      this.reporter_.reportError(pos, ("Duplicate parameter name " + name));
    },
    maybeReportDuplicateError_: function(name, pos) {
